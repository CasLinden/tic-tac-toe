...
const Player = (name, symbol) => {
    ...
    const play = (number) => {
            ...
            if (symbol === 'X'){
                ...
                <svg  class='x' width="140" height="140" viewBox="0 0 222 217" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            if (symbol === 'O'){
                playedField.innerHTML =
                `<svg class='o'width="120" height="120" viewBox="0 0 144 161" fill="none" xmlns="http://www.w3.org/2000/svg">
